...
window.Form = form_backend_validation__WEBPACK_IMPORTED_MODULE_0__["default"];
var app = new Vue({
  el: '#app',
  data: {
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.form['post']('/') // 適切なパスに変更してください！
      .then(function (response) {
        return _this.displaySuccessMessage('Your account was created');
      })["catch"](function (response) {
        return _this.displayErrorMessage('Your account was not created');
      });
    },
